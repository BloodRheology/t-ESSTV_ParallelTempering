function [dy] = mHAWB_ODE(t,y )

global    Mu0_c MuINF_c TauC tr1 tr2 at d m MuR Sigy0 Gc GR TauLAM SHEAR GammaINF TimeVECT ShearVECT ZZZZ
...
%Components:
SigmaDxx=(y(6)-TRACE/3);  SigmaDyy=(y(7)-TRACE/3); SigmaDzz=(y(8)-TRACE/3);  SigmaDyx=(y(5));
